...
import { pharmaceuticalsRoutes } from "./modules/pharmaceuticals/pharmaceuticals.routes";
import { auditController } from "./modules/audit/audit.routes";
import { standardsController } from "./modules/standards/standards.controller";
...
console.log(
  `🐔 SakhaFarm API running at ${app.server?.hostname}:${app.server?.port}`,
);
