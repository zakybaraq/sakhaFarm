...
const mockPermissions = [
  ...
  { id: 'plasmas.update', name: 'Update Plasma', category: 'plasmas' },
  { id: 'plasmas.delete', name: 'Delete Plasma', category: 'plasmas' },
  { id: 'cycles.read', name: 'View Cycles', category: 'cycles' },
  { id: 'cycles.create', name: 'Create Cycle', category: 'cycles' },
  { id: 'cycles.update', name: 'Update Cycle', category: 'cycles' },
  { id: 'cycles.delete', name: 'Delete Cycle', category: 'cycles' },
